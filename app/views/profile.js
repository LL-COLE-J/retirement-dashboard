...
function ensureProfileCoreFields(grids,values){
  ...
  ensureProfileField(grids.income,'income1','Income 1','<input id="income1" type="number" value="'+value('income1','85000')+'" oninput="commit()">');
  ensureProfileField(grids.income,'income2','Income 2','<input id="income2" type="number" value="'+value('income2','0')+'" oninput="commit()">');
  ...
  ensureProfileField(grids.expenses,'currentSpend','Current Spend','<input id="currentSpend" type="number" value="'+value('currentSpend','45600')+'" oninput="commit()">');
  ensureProfileField(grids.expenses,'retireSpend','Retirement Spend','<input id="retireSpend" type="number" value="'+value('retireSpend','38400')+'" oninput="commit()">');
  ...
  ensureProfileField(grids.debts,'debt','Debt','<input id="debt" type="number" value="'+value('debt','22000')+'" oninput="commit()">');
