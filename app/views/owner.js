function renderOwnerView(){
  ...
  <header class="owner-header">
    ...
    <div class="owner-badge">Bastion Save State 2.39f</div>
  </header>

  <section class="owner-section">
    <h2>Owner Command Summary</h2>
    <div class="owner-report-grid">
      <div class="owner-report-field"><span>Current Save State</span><strong id="ownerSummarySaveState">Bastion Save State 2.39f</strong></div>
      <div class="owner-report-field"><span>Active Phase</span><strong id="ownerSummaryPhase">2.39f Scenario Delta Repair</strong></div>
