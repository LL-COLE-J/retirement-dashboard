function renderReportsView() {
  ...
  reportsCard.innerHTML = '<div class="report-brand-row"><img class="brand-asset brand-report-img" src="assets/brand/beacon-keep-shield.png" alt="Bastion Insights Plan Snapshot Report"><span class="report-brand-note">Canonical Beacon Keep report identity</span></div>'+
    ...
    '<div class="view-status-banner"><span class="view-status-label status-future">Future Phase</span><span>Reports are a snapshot surface only. Export, advisor delivery, and full report generation remain future phases.</span></div>'+
