function renderReportsView() {
  ...
  reportsCard.innerHTML = '<div class="report-brand-row"><img class="brand-asset brand-report-img" src="app/assets/brand/bastion-report-mono.svg" alt="Bastion Insight Plan Snapshot Report"><span class="report-brand-note">Monochrome report variant</span></div>'+
