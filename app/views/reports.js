function renderReportsView() {
  ...
  reportsCard.innerHTML = '<div class="report-brand-row"><img class="brand-asset brand-report-img" src="app/assets/brand/bastion-tower-lockup.svg" alt="Bastion Insights Plan Snapshot Report"><span class="report-brand-note">Executive briefing brand system</span></div>'+
