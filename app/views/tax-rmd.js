function renderTaxRmdView(){
  ...
  taxCard.innerHTML = '<div class="tax-header"><div><div class="tax-pill">Future Phase</div><h3>Your Withdrawal Plan</h3><p>Lightweight tax-planning view for compliance, withdrawal order, and stress-tested downside.</p></div><span class="tax-pill">Save State 2.43</span></div>'+
