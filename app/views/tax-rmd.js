function renderTaxRmdView(){
  ...
  taxCard.innerHTML = '<div class="tax-header"><div><div class="tax-pill">Future Phase</div><h3>Your Withdrawal Plan</h3><p>Lightweight tax-planning view for compliance, withdrawal order, and stress-tested downside.</p></div><span class="tax-pill">Save State 2.41b</span></div>'+
    '<div class="view-status-banner"><span class="view-status-label status-future">Future Phase</span><span>Tax and RMD content is intentionally educational/placeholder-level. It is not CPA-level guidance and needs a dedicated rules/versioning phase before beta reliance.</span></div>'+
    '<div class="tax-grid cols-2">'+
    '<div class="tax-card tax-kpi-card"><h4>Tax / RMD Compliance</h4><div class="tax-metric tax-good" id="taxComplianceStatus">ON TRACK</div><div class="tax-muted" id="taxComplianceNote">One-line reason appears after projection.</div></div>'+
    '<div class="tax-card tax-kpi-card"><h4>Estimated Lifetime Taxes</h4><div class="tax-metric" id="lifetimeTaxMetric">Needs input</div><div class="tax-muted" id="taxImpactComparison">Withdrawal order recommendation appears after projection.</div></div>'+
    '</div>'+
    '<div class="tax-card advisor-insight-card"><h4>Advisor Insight</h4><div class="tax-muted" id="taxMeaning">Run the model for a plain-English summary.</div></div>'+
    ...
    '<details class="mobile-detail-panel" open><summary><span>RMD details</span><small>Education and 5-year schedule.</small></summary><div class="tax-grid cols-2">'+
    ...
    '</div>'+
    '<details class="mobile-detail-panel" open><summary><span>Scenario and stress details</span><small>Comparison and downside context.</small></summary><div class="tax-grid cols-2">'+
    '<div class="tax-card scenario-polish-card"><h4>Scenario Impact Comparison</h4><div class="tax-muted" id="taxImpactDetail">Needs input</div></div>'+
